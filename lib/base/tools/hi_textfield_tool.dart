...
///
class HiTextFieldTool extends StatefulWidget {
  const HiTextFieldTool({
    Key? key,
    required this.child,
  ...
  @override
  _HiTextFieldToolState createState() => new _HiTextFieldToolState();
}

///
/// We implement the WidgetsBindingObserver to be notified of any change to the window metrics
///
class _HiTextFieldToolState extends State<HiTextFieldTool>
